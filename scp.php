...
//######################################################################
	...
	set_screenshot('scp', '03.jpg');
	set_screenshot('scp', '04.jpg');
	set_screenshot('scp', '05.jpg');
	set_screenshot('scp', '06.jpg');
	set_screenshot('scp', '07.jpg');
	set_screenshot('scp', '08.jpg');
	set_screenshot('scp', '09.jpg');
	set_screenshot('scp', '10.jpg');
	set_screenshot('scp', '11.jpg');
	set_screenshot_end();
